/**
 * Sincroniza Firebase Authentication con el email del jugador (Firestore).
 * Usado desde API routes y debe mantenerse alineado con functions/src/playerAuthSync.ts
 */
...
/**
 * Mantiene Firebase Auth alineado con el email del jugador: crea cuenta si faltaba,
 * o actualiza el email si ya existía con el correo anterior.
 */
...
/** Normaliza email desde datos Firestore (import, consola, etc.). */
