...
const improveMassMessagePrompt = ai.definePrompt({
  ...
  prompt: `
Eres un asistente de comunicación de una escuela de fútbol. Tu tarea es redactar o mejorar un mensaje que el administrador de la escuela enviará por correo a los jugadores y sus familias.
