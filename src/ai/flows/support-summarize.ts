...
const supportSummarizePrompt = ai.definePrompt({
  ...
  prompt: `
Eres un asistente de clasificación de tickets de soporte para una app web multi-tenant de escuelas de fútbol. El usuario describe un problema en texto libre.
